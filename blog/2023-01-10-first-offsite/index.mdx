...
My first startup job was at [Strong](https://www.strong.app/), a workout-tracking app that was pretty popular at the time. The founders were “digital nomads,” and the team was fully remote.

Back in 2016, it was highly uncommon.
...
The Firezone gateway is tightly coupled with the control plane. To support multi-site environments, we’ll need to support managing multiple gateways with a single control-plane. During the offsite, we architected and began work on this major change. 
...
You can also expect more blog posts from us. One of our New Year's resolutions at Firezone is to write more. We want to be transparent with how we build our product, run our company, and make important decisions that impact you. We do this because we don’t take your trust in Firezone for granted.
