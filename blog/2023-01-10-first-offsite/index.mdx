...
:::note A WORD FROM OUR SPONSOR  
_Firezone secures user access to private resources. This post doesn't have much to do about security, networking, or a fancy new feature. But hey, our product makes the remote work experience better - organizing a great off-site helps too._

_If you want to try it out, our [Docker install script](https://docs.firezone.dev/) gets Firezone running in just a few minutes._
:::
